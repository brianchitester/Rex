    ...
    useEffect(() => {
        (async () => {
            ...
            setClassifications({
                ...
                genre: Object.keys(c.genre).sort(
                    (a, b) => c.genre[b] - c.genre[a]
                )[0],
                type: Object.keys(c.type).sort(
                    (a, b) => c.type[b] - c.type[a]
                )[0]
            });
        ...
        <AudioPlayerProvider>
            <StyledPlayerContainer>
                ...
                >
                    <Box
                        onClick={() =>
                            navigate(`/trackDetails/${currentTrack.id}`)
                        }
                        sx={{
                            margin: 2,
                            marginRight: 0
